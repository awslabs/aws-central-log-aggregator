...
/**
 * Kinesis Reader and Writer for logs - Uses Spark Streaming
 *
 * @author Kiran S
 */
...
public class KinesisConnector extends BaseLogConnector {

    private static final Logger logger = Logger.getLogger(KinesisConnector.class);
